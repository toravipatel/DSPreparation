...
class UnionFind
{
    ...
    fun find(value:Int) = numsArray[value]
    ...
    fun union(source: Int, destination: Int){
        ...
        if(sourceRoot != destinationRoot){
            ...
            for (i in numsArray) {
                ...
                if(numsArray[i] == destinationRoot){
                    numsArray[i] = sourceRoot
                }
            }
    ...
    fun connected(source:Int,destination: Int):Boolean{
        return numsArray[source] == numsArray[destination]
    }
